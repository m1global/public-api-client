import { StellarRedemptionBody } from "../interfaces";
import { postToAPI } from "./post-to-api";

/**********************************************************************************
 * Typescript function that calls the M1 API Stellar endpoint for redemptions
...
export async function redeem(
    ...
    const url = `${process.env.M1_API_BASE_URL}/stellar/broker/redemptions`;

    // POST payload
    const body: StellarRedemptionBody = {
