...
/**********************************************************************************
 * Typescript function that calls the M1 API Ethereum endpoint for redemptions and
...
export async function getRedemption(
    ...
    let url = `${process.env.M1_API_BASE_URL}/ethereum/broker/redemptions/${redeemerAddress}`;
